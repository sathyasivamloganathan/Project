...
function AdminSaves() {
  ...
  const filterMetaData = metadata.filter((item) => item.PatientId.includes(search));

  return (
    <div>
      <h1 className="text-[20px] text-center my-5 text-gray-700">Reports you saved</h1>
      <div>
        <input type="text" placeholder="Search by patient Id" value={search} onChange={(e) => setSearch(e.target.value)}/>
      </div>
